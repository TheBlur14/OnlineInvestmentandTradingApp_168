...
const HomePage=()=>{
    ...
    return(
      <div style={{backgroundImage: "url(/images/bg2.jpg)", minHeight:"150vh", width:"100%", backgroundRepeat: "none", backgroundSize:"cover",position: "absolute"}}>
            <div>
               <Dashboard /> 
            ...
            <div style={{marginLeft: 750,marginTop: 130}}>
               <Card sx={{ maxWidth: 345,marginRight: 30}}>
                ...
                <br></br><br></br>
                <h1 style={{marginLeft: 420}}>About US</h1>
